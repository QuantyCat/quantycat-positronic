#!/usr/bin/env python3
"""Run focused high-motion eval for the h1/j1-j2-j3 balanced epoch-8 checkpoint."""
...
CHECKPOINT = (
    ...
    / "screwdriver_so101_h1j123_balanced_scratch/epoch8"
)
...
OUTPUT_DIR = (
    REPO
    / "eval_output/screwdriver_so101/model_eval/h1j123_balanced_epoch8/"
    / "broad_j3_high_motion_top50"
)
LOG = REPO / "run_logs/h1j123_epoch8_high_motion_eval.log"
