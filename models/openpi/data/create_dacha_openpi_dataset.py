#!/usr/bin/env python3
"""Create an OpenPI/LeRobot v2.1-compatible view of the Dacha v3 dataset."""
...
def main() -> None:
    ...
    parser.add_argument("--source", type=Path, default=Path.home() / "quantycat-data/datasets/dacha/dacha_v3")
    parser.add_argument(
        "--target",
        type=Path,
        default=Path.home() / "quantycat-data/datasets/dacha/dacha_v3_openpi_v21",
    )
