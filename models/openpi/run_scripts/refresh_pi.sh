...
cp "$PATCHES_DIR/src/openpi/training/data_loader.py"  "$OPENPI_REPO/src/openpi/training/data_loader.py"
cp "$PATCHES_DIR/scripts/compute_norm_stats.py"       "$OPENPI_REPO/scripts/compute_norm_stats.py"
